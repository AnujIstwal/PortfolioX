...
export default function Projects() {
  ...
  return (
    <motion.div className="relative mt-10 flex h-full w-full flex-col items-center justify-center gap-y-6 rounded-3xl bg-[#1A1A1A] px-8 py-12 pt-8 sm:h-screen sm:gap-y-0 sm:p-8">
      <img
        src="project-bg.png"
        alt="project"
